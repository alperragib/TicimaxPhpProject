...
echo "Testing ProductService::getProductCount()\n";
...
try {
    ...
    $categoryCount = $productService->getProductCount(['KategoriID' => 1]);
    ...
    $complexCount = $productService->getProductCount([
        'Aktif' => 1,
        'Vitrin' => 1,
        'ToplamStokAdediBas' => 1
    ]);
